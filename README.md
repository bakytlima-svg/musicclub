...
| **[Student 2 Name]** (Student 2) | `equipment.html`<br>`bands.html` | Technical studio hardware inventory table, active university bands catalogue, reservation inquiry form. |
